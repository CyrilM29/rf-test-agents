...
def main() -> int:
    ...
    # Le tiret cadratin se vérifie sur TOUT fichier édité, pas seulement sur
    # les artefacts du cycle agentique : c'est une règle de rédaction globale,
    # et la rattraper à l'écriture coûte moins qu'une relecture entière.
    if file_path:
